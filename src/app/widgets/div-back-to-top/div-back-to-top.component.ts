...
@Component({
  selector: 'app-div-back-to-top',
 
  imports: [CommonModule],
  templateUrl: './div-back-to-top.component.html',
  styleUrls: ['./div-back-to-top.component.scss']
})
export class DivBackToTopComponent implements OnInit, OnDestroy {
